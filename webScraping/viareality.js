	...
	const nightmarePromise = new Promise( (resolve, reject) => {
		nightmare
			...
			.then(response => {
				...
				$(".main-info:last-of-type > div.contact > div.row > div:last-of-type > vre-modal > div.modal > div.modal-dialog > div.modal-content > div.modal-body > div > div.broker-modal-body > div.broker-modal-block > div.row > div.broker-info").filter(function() {
					let data = $(this);
